...
impl<const P: u64> Arith<P> {
    ...
    pub const MAX_NTT_LEN: u64 = 2u64.pow(Self::factors(2)) * 3u64.pow(Self::factors(3)) * 5u64.pow(Self::factors(5));
    pub const ROOTR: u64 = {
    ...
    pub fn build<const P: u64>(min_len: usize) -> Self {
        ...
        for m7 in 0..=1 {
            for m5 in 0..=Arith::<P>::factors(5) {
                ...
                if len75 >= 2 * min_len as u64 { break; }
...
pub fn conv<const P: u64>(plan: &NttPlan, x: &mut [u64], xlen: usize, y: &mut [u64], ylen: usize, mut mult: u64) {
...
pub const P1P2INV_R_MOD_P3: u64 = Arith::<P3>::mmulmod(Arith::<P3>::R2, arith::invmod((P1 as u128 * P2 as u128 % P3 as u128) as u64, P3));
